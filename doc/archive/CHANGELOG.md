...
- Additional wrapper classes for game API
...
### Added
- **PerAspera.GameAPI.Wrappers** - Type-safe wrappers for game objects
- **PerAspera.GameAPI.Commands** - Command system integration
- **PerAspera.GameAPI.Events** - Enhanced event system with typed subscriptions
- **PerAspera.GameAPI.Climate** - Climate system helpers and data models
- **PerAspera.GameAPI.Overrides** - Game behavior override utilities
- **PerAspera.Core.IL2CppExtensions** - Extended IL2CPP utilities
- Complete archiving system for SDK versions
- Improved NuGet package management

### Changed
- Upgraded to stable release version (no longer beta)
- Enhanced error handling and validation
- Improved documentation and examples
- Better IntelliSense support

### Fixed
- DLL copy issues resolved
- Reference management improvements
- Memory optimization for IL2CPP interop
